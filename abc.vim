...
silent only
silent tabonly
cd ~/gitclones/homepageJIH/rprojects/teaching/MSB104TimeSeriesJIH
...
edit vignettes/application/Application_Fertility_lagged.Rmd
...
wincmd w
argglobal
terminal ++curwin ++cols=57 ++rows=50 R
...
exe 'vert 2resize ' . ((&columns * 57 + 114) / 228)
tabnext 1
badd +0 vignettes/application/Application_Fertility_lagged.Rmd
