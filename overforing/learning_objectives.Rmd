...
- General model
  - $y=\alpha+\delta_{0}z_{t}+\delta_{1}z_{t-1}+\delta_{t-2}z_{2}+\delta_{3}z_{t-3}+u_{t}$
...
1. TS.1, TS.2, TS.3, TS.4, TS.5 and TS.6 $\Rightarrow$ OLS estimatiors $\beta_{j} for j=0,1,..,k$ are normaly distributed
...
- MA(1) process $y_{t}=\alpha_{}e_{t-1}+e_{t}$
...
# 16: Simultanous equations models (SEM) -- only for MSB104 students 
