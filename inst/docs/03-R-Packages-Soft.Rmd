...
```{r, eval=F, include=F}
xaringan::inf_mr("03-R-Packages-Soft.Rmd")
rmarkdown::render("03-R-Packages-Soft.Rmd")
...
toc <- readLines("03-R-Packages-Soft.Rmd")
tocc <- character()
...
- Onsdag 4 timer og torsdag 6 timer
- Jørn Inge Halvorsen kommer til å være på campus Haugesund onsdag 13.oktober og torsdag 14.oktober og vi legger opp til utvidet undervisning i MSB104 Økonometri disse dagene. Nærmere informasjon kommer og det vil også bli gjort timeplanendringer slik at vi er sikker på at det er rom på campus for økt aktivitet. Reserver begge disse to dagene til en god arbeidsøkt i MSB104.
